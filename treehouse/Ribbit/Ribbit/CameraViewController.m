...
#pragma mark - Image Picer Controller delegate
...
-(void)uploadMessage {
    ...
    [file saveInBackgroundWithBlock:^(BOOL succeeded, NSError * _Nullable error) {
        ...
        if (error) {
            ...
            UIAlertController *alertView = [UIAlertController alertControllerWithTitle:@"An Error occured" message:@"Please tyr sending your message again." preferredStyle:UIAlertControllerStyleAlert];
